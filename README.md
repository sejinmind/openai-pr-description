# `sejinmind/openai-pr-description` GitHub Action
...
| `openai_model`    | The [OpenAI model] to use                             | No       | `gpt-5.4`                  |
| `max_tokens`      | The maximum number of **completion tokens** to generate | No     | `4096`                     |
